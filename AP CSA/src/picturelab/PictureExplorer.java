...
public class PictureExplorer implements MouseMotionListener, ActionListener, MouseListener
{
  ...
  private void setUpNextAndPreviousButtons()
  {
    ...
    Icon prevIcon = new ImageIcon(DigitalPicture.class.getResource(File.separator + "images" + File.separator + "leftArrow.gif"), 
                                  "previous index");
    Icon nextIcon = new ImageIcon(DigitalPicture.class.getResource(File.separator + "images" + File.separator + "rightArrow.gif"), 
                                  "next index");
