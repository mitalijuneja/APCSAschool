...
public class SimplePicture implements DigitalPicture
{
 ...
 public SimplePicture(String fileName)
 {
	 ...
	 String file = "src" + File.separator + "picturelab" + File.separator + "images" + File.separator + fileName;
 ...
 {
     String file = "src" + File.separator + "picturelab" + File.separator + "images" + fileName;
	 try {
