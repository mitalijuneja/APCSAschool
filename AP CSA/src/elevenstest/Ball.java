...
public class Ball extends Block implements Collidable
{
   ...
   //add the get methods
	...
	{
		Block b = (Block)obj;
		if ((this.getX() +this.getWidth()>= b.getX() - Math.abs(this.getXSpeed()) && (this.getY() >= b.getY() && this.getY() <= b.getY() + b.getHeight() || this.getY() + this.getHeight() >= b.getY() && this.getY() + this.getHeight() < b.getY() + b.getHeight())))
		{
			if (!(this.getX() >= b.getX() + Math.abs(this.getXSpeed())))
			{
				return true;
			}
		}
	...
	{
		Block b = (Block)obj;
		if ((this.getX() <= b.getX() + b.getWidth() + Math.abs(this.getXSpeed()) && (this.getY() >= b.getY() && this.getY() <= b.getY() + b.getHeight() || this.getY() + this.getHeight() >= b.getY() && this.getY() + this.getHeight() < b.getY() + b.getHeight())))
		{
			if (!(this.getX() <= b.getX() + b.getWidth() - Math.abs(this.getXSpeed())))
			{
				return true;
	...
	{
		Block b = (Block)obj;
		if (this.getY() == b.getY() + b.getHeight() && (this.getX() + this.getWidth() >= b.getX() && this.getX() + this.getWidth() <= b.getX() + b.getWidth()))
		{
			return true;
		}
		return false;
	...
	public boolean didCollideBottom (Object obj)
	{
		...
		if (this.getY() + this.getHeight() == b.getY() && (this.getX() + this.getWidth() >= b.getX() && this.getX()  + this.getWidth()<= b.getX() + b.getWidth()))
		{
			return true;
		}
		return false;
